 ...
 *
 *   gpAssert.h
 *   This file contains the defenitions of the public functions and enumerations of the gpAssert.
 *
 *
 ...
 *      EF                 @
 *     0!                         $Header: //depot/release/Embedded/BaseComps/v2.4.8.0/sw/comps/gpAssert/inc/gpAssert.h#1 $
...
// old unittests do not use setjmp/longjmp mechanism, define action nothing for them
#if defined(GP_DIVERSITY_OLD_UNITTEST_APPROACH)
#define GP_DIVERSITY_ASSERT_ACTION_NOTHING
#endif
...
/** @brief Call condition untill timeout expires.
 *
...
/** @brief Call condition untill timeout expires. Assert if timeout is reached.
 *
