 ...
 *      EF                 @
 *     0!                         $Header: //depot/release/Embedded/BaseComps/v2.4.8.0/sw/comps/gphal/inc/gpHal_ES.h#1 $
 ...
 * @param eventNbr                 The index of the Absolute Event (1..16).
*/
GP_API void gpHal_ScheduleAbsoluteEvent(gpHal_AbsoluteEventDescriptor_t* pAbsoluteEventDescriptor, UInt8 eventNbr);
 ...
 * @param eventNbr                 The index of the Absolute Event (1..16).
*/
GP_API void gpHal_RefreshAbsoluteEvent(UInt32 absTime, UInt8 control, UInt8 eventNbr);
 ...
 * @param eventNbr The index of the Absolute Event (1..16).
*/
GP_API gpHal_EventState_t gpHal_UnscheduleAbsoluteEvent(UInt8 eventNbr);
...
*/
GP_API void gpHal_SetSleepMode(gpHal_SleepMode_t mode);
