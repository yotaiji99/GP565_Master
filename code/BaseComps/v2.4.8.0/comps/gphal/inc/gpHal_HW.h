 ...
 *      EF                 @
 *     0!                         $Header: //depot/release/Embedded/BaseComps/v2.4.8.0/sw/comps/gphal/inc/gpHal_HW.h#1 $
...
/* use this to un-force low-level signals */
#define GP_HAL_TDC_DISABLE(Property) GP_HAL_UNSAFE_WRITE_PROP(Property##_TDC_ENABLE, false)

//i'm not sure if the following optimisation is valid for GP chip.
/** part of implementation, don't use */
...
/** @brief Generates the signed mask of a property. */
#define GP_HAL_SIGNEDMASK(Prop) ((UInt8)~(Prop##_MASK >>  Prop##_LSB))
