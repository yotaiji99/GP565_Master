 ...
 *      EF                 @
 *     0!                         $Header: //depot/release/Embedded/BaseComps/v2.4.8.0/sw/comps/gpEncryption/inc/gpEncryption.h#1 $
...
#define GP_ENCRYPTION_OPTIONS_IS_HARDENED(id) (id & gpEncryption_Hardened)
...
*/
GP_API gpEncryption_Result_t gpEncryption_AESEncrypt(UInt8* pInplaceBuffer, UInt8* pAesKey, UInt8 options);
